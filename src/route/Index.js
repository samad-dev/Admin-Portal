...
import CabinetList from "../components/dk_pages/Cabinet";
import FolderList from "../components/dk_pages/Folders";
import UsersList from "../components/dk_pages/Users";
import AclList from "../components/dk_pages/Acl";
import Roles from "../components/dk_pages/Roles";
import CustomeFieldList from "../components/dk_pages/custom_field";
import OrgList from "../components/dk_pages/Organization";
  ...
  return (
    <Suspense fallback={<div />}>
      <Switch>
        ...
        <Route exact path={`${process.env.PUBLIC_URL}/cabinets`} component={CabinetList}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/folders`} component={FolderList}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/users`} component={UsersList}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/acl`} component={AclList}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/custom_field`} component={CustomeFieldList}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/org`} component={OrgList}></Route>
